...
from models.params import TD3Params
import copy

class TD3(RLModel):
    def __init__(self, state_size: List[int], action_size: int, action_range_min: float, action_range_max: float, params: TD3Params):
    ...
    def update_models(self) -> None:
        for repeat in range(self.params.repeats_per_update):
            ...
            with torch.no_grad():
                ...
                td_target: Tensor = reward_tensor + self.params.gamma * (1 - episode_terminated_tensor) * torch.min(pred_next_q_value1, pred_next_q_value2)
    ...
    def new(self) -> RLModel:
        return TD3(self.state_size, self.actions_amount, self.action_range_min, self.action_range_max, self.params)
    
    def save(self) -> None:
        torch.save(self.q_value_model1.state_dict(), "./saved_models/td3_q1.pth")
        torch.save(self.q_value_model2.state_dict(), "./saved_models/td3_q2.pth")
        torch.save(self.policy_model.state_dict(), "./saved_models/td3_policy.pth")
